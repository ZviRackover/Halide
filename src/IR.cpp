...
template<> EXPORT void ExprNode<Undef>::accept(IRVisitor *v) const { v->visit((const Undef *)this); }
...
template<> EXPORT Expr ExprNode<Undef>::mutate_expr(IRMutator2 *v) const { return v->visit((const Undef *)this); }
